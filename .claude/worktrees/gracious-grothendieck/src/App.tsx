      ...
      <div className="grid md:grid-cols-4 gap-12 mb-16">
        <div>
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a href="https://wa.me/573044234590" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ color: 'rgba(255,255,255,0.5)' }}><MessageSquare className="w-5 h-5" /></a>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            <li><a href="https://wa.me/573044234590?text=Hola%2C+me+gustar%C3%ADa+solicitar+una+evaluaci%C3%B3n+gratuita+con+el+Dr.+Agudelo." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm" style={{ color: 'rgba(255,255,255,0.5)', fontWeight: 400, textDecoration: 'none' }}><MessageSquare className="w-4 h-4 shrink-0" style={{ color: 'rgba(255,255,255,0.4)' }} />304 423 4590</a></li>
            ...
            <li><a href="tel:+573044234590" className="flex items-center gap-2 text-sm" style={{ color: 'rgba(255,255,255,0.5)', fontWeight: 400, textDecoration: 'none' }}><Phone className="w-4 h-4 shrink-0" style={{ color: 'rgba(255,255,255,0.4)' }} />304 423 4590</a></li>
          </ul>
        </div>
      </div>
...
const WhatsAppButton = () => (
  <a href="https://wa.me/573044234590?text=Hola%2C+me+gustar%C3%ADa+solicitar+una+evaluaci%C3%B3n+gratuita+con+el+Dr.+Agudelo." target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp"
    className="flex fixed bottom-24 md:bottom-8 right-4 md:right-8 z-50 items-center justify-center w-12 h-12 md:w-14 md:h-14 transition-transform duration-200 hover:scale-110"
    style={{ borderRadius: '50%', background: '#25D366', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' }}
  ><MessageSquare className="w-5 h-5 md:w-6 md:h-6" style={{ color: '#fff' }} /></a>
)
