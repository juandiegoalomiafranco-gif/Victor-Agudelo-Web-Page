...
description: Creates new skills for the Antigravity agent based on user requirements. Use when the user asks to build, create, or generate a new skill, or mentions automating tasks via skills.
---
