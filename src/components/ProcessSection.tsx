...
const ProcessSection = () => {
  return (
    <section id="proceso" className="py-24 lg:py-32 bg-secondary border-y border-border">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground leading-tight">
            De la idea a la <span className="text-gradient-gold italic">realidad</span>
          </h2>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="relative z-10 w-16 h-16 mx-auto mb-6 bg-background border border-border rounded-full flex items-center justify-center group hover:border-accent transition-colors duration-300">
                <step.icon size={24} className="text-accent" />
              </div>
              <span className="text-accent/30 text-5xl font-heading font-bold absolute top-0 right-4 lg:right-auto lg:left-1/2 lg:-translate-x-1/2 lg:-top-3 select-none">
                {step.number}
              </span>
